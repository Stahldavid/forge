    ...
    try {
      ...
      writeFileSync(
        ...
        [
          ...
          "}",
          "const workOSAuthProvider = async () => workOSSessionToForgeAuth({ claims: { sub: 'user_test', organization_id: 'tenant_test', permissions: ['onboarding:read'] } });",
          "export function ForgeWorkOSAuthProvider() {",
          "  return <ForgeProvider auth={workOSAuthProvider} />;",
          "}",
